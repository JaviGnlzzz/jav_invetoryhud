...
function loadPlayerInventory()
    ESX.TriggerServerCallback("jav_invetoryhud:getPlayerInventory",
        function(data)
            items = {}
            fastItems = {}
...
RegisterNetEvent("jav_invetoryhud:openTrunkInventory")
AddEventHandler(
    "jav_invetoryhud:openTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
        openTrunkInventory()
    end
)
RegisterNetEvent("jav_invetoryhud:refreshTrunkInventory")
AddEventHandler(
    "jav_invetoryhud:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        TriggerServerEvent("jav_invetoryhud:changeFastItem", data.slot, data.item.name)
        loadPlayerInventory()
        cb("ok")
    end
)
RegisterNUICallback(
    ...
    function(data, cb)
        fastWeapons[data.item.slot] = nil
        TriggerServerEvent("jav_invetoryhud:changeFastItem", 0, data.item.name)
        loadPlayerInventory()
        cb("ok")
    end
)
...
--Add Items--
RegisterNetEvent('jav_invetoryhud:client:addItem')
AddEventHandler('jav_invetoryhud:client:addItem', function(itemname, itemlabel)
